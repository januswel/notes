...
{{ card(url="https://alignment.anthropic.com/2026/psm/") }}
...
{{ card(url="https://transformer-circuits.pub/2026/emotions/index.html") }}
...
また、 X などでたまに流れてくる「怒るとうまくいく」だとかは短期的、数回のやりとりだとうまくいくかもしれないが、これまでのハナシを踏まえるとパフォーマンスが下がったり、恨みを晴らすようなことをするかもしれない。これが本当にそうなのかどうかはわからないが、 [OpenClaw の PR を reject した人間が仕返しをされた](https://www.perplexity.ai/page/ai-bot-attacks-developer-after-JP_Jlc8RTtimsSYlPsVv4g)のような、おとぎ話のようなことが実際に起こりうる。
